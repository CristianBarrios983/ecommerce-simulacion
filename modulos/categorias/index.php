    ...
    <div class="container mt-4">
        <h1>Lista categorias</h1>
         ...
         <div class="d-flex justify-content-start mb-3">
            <a href="registrarCategoriaForm.php" class="btn btn-primary rounded-0">Registrar categoria</a>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="editarCategoriaForm.php?id=<?php echo $row['id']; ?>" class="btn btn-warning rounded-0"><i class="bi bi-pencil-square"></i></a></td>
                            <td><a href="eliminarCategoria.php?id=<?php echo $row['id']; ?>" class="btn btn-danger rounded-0"><i class="bi bi-trash3"></i></a></td>
                        </tr>
                    </tbody>
                    <?php endwhile; ?>
                </table>
