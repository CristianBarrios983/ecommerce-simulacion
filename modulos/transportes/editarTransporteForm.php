...
<html lang="en">
  ...
  <body class="bg-secondary-subtle">
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        ...
        ?>
        <form action="actualizarTransporte.php" method="post" class="border p-3 bg-white needs-validation" style="width: 18rem;" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="empresa" value="<?php echo $row['empresa'] ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="tiempo-entrega" value="<?php echo $row['tiempo_entrega'] ?>" required>
                <div class="invalid-feedback">
                    Campo obligatorio
                </div>
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="precio-envio" value="<?php echo $row['precio_envio'] ?>" required>
                <div class="invalid-feedback">
                    Campo obligatorio
                </div>
            </div>
